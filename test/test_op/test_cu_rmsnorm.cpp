...
TEST(test_rmsnorm_cu, rmsnorm_nostream) {
  ...
  int32_t total_num = 32 * 15;

  tensor::Tensor in_cpu(base::DataType::kDataTypeFp32, total_num, true, alloc_cpu);
  tensor::Tensor wei_cpu(base::DataType::kDataTypeFp32, total_num, true, alloc_cpu);
  tensor::Tensor out_cpu(base::DataType::kDataTypeFp32, total_num, true, alloc_cpu);
