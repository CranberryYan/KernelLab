#ifndef KERNELLAB_INCLUDE_MODEL_LLAMA_CONFIG_H_
#define KERNELLAB_INCLUDE_MODEL_LLAMA_CONFIG_H_
#include <iostream>
...
struct TransformerConfig {
  ...
  friend std::ostream& operator<<(
    std::ostream& os, const TransformerConfig& obj) {
    return os << "\nkv_dim: " << obj.kv_dim_
              << "\nkv_mul_: " << obj.kv_mul_ << "\n"
...
#endif // KERNELLAB_INCLUDE_MODEL_LLAMA_CONFIG_H_
