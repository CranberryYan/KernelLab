#ifndef KERNELLAB_INCLUDE_BASE_BASE_H_
#define KERNELLAB_INCLUDE_BASE_BASE_H_
...
inline size_t DataTypeSize(DataType data_type) {
  ...
  } else if (data_type == DataType::kDataTypeUInt32) {
...
public:
  ...
  // 拷贝构造和拷贝赋值用于STATUS_CHECK中的const base::Status& status = call;
...
#endif // KERNELLAB_INCLUDE_BASE_BASE_H_
